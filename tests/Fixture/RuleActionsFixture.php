 ...
 *
 */
class RuleActionsFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'workflow_rule_actions';
    ...
    public $fields = [
        ...
        'action_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
